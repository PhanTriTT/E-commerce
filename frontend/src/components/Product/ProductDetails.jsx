...
const ProductDetails = () => {
  ...
  const addToFavouriteHandler = () => {
    ...
    toast.success('Product Added to Favourites', { position: 'top-right' })
  }
  ...
  const reviewSubmitHandler = (e) => {
    ...
    const myForm = { rating: Number(rating), comment, productId: id }

    if (isAuthenticated !== true) {
      navigate(`/login`)
    } else if (comment.length === 0) {
      toast.error('Please fill the comment box', { position: 'top-right' })
    } else {
